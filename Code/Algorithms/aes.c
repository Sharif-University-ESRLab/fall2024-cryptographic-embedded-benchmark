...
int main(int argc, char *argv[])
{
    ...
    for (iteration = 0; iteration < num_itr; iteration++) {
        ...
        // the cipher key
        unsigned char key[16] = {'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26)};

        // the cipher key size
        enum keySize size = SIZE_16;

        // the plaintext
        unsigned char plaintext[16] = {'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26), 'A' + (random() % 26)};
    ...
    avg=avg/num_itr;
    var=var-num_itr*pow(avg,2);
    std=pow(var,0.5);
    printf("Average execution time = %f  seconds\n", avg);
    printf("Worst execution time = %f  seconds\n", worst);
    printf("Standard deviation = %f \n",std);
    printf("Average+3sigma= %f Seconds\n",avg+3*std);
    return 0;
}
