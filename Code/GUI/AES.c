...
int main(int argc, char *argv[])
{
    ...
    for (iteration = 0; iteration < num_itr; iteration++) {
        ...
        // the cipher key
        unsigned char key[16] = {'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26)};

        // the cipher key size
        enum keySize size = SIZE_16;

        // the plaintext
        unsigned char plaintext[16] = {'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26), 'A' + (rand() % 26)};
